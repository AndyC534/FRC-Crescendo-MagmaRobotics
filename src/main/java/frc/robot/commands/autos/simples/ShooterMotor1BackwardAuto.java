...
public class ShooterMotor1BackwardAuto extends Command {
    ...
    public ShooterMotor1BackwardAuto(Shooter ShooterMotor1, double duration, double power, double rightpower) {
    ...
    public void execute() {
        this.ShooterMotor1.ShooterMotor1BackwardAuto(power);
    }
